function main() {
  document.body.insertAdjacentHTML('afterbegin', '<style>.cookie-banner,.footer-guide,.backdrop-12,.backdrop-11,.backdrop-10,.backdrop-9,.backdrop-8,.backdrop-7,.backdrop-6,.backdrop-5,.backdrop-4,.backdrop-3,.backdrop-2,.backdrop-1,.backdrop-0{display:none!important}.tiktok-bottom.bottom{bottom:0px!important}</style>');

  setInterval(function() { check();check2() }, 500);
  ...
  function check2() {
    if (document.querySelector(".side-bar-mobile-container") != null) {
      if(document.getElementById("credit") == null) {
        document.querySelector("div.footer-content-column").insertAdjacentHTML('beforeend', '<span style="display: block;" id="credit"><a class="item-sub-column" target="_blank" href="https://github.com/Knuspie/TikTok-mobile-addon.git"><h5>Addon by Knuspie</h5></a></span>');
      }
    }
  }
}
...
//todo: copy link button fixen + github credit + nice animation maybe ...